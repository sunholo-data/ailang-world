...
4. [**[IN-SPRINT] — M3.A LANDED 2026-07-28 (iter-31), dev CI green, PR #20 → squash `2edf2ef`,
   judge sonnet PASS 84/100 zero-blocking. **M3.D IS RATIFIED — Mark, attended, `c26b27d`:
   OPTION (i), and Decision 3 is REOPENED for a third `failed` arm. NO human gate is outstanding
   on this item.** M3.B is NEXT.**
