...
**Next iteration**: sprint-planner (opus) → executor (opus, worktree) → evaluator (sonnet) → PR → CI. **AILANG-knowledge review + retrofit of M1 milestone-1 (`world/{contracts,transitions,logepoch,types}.ail`)**
