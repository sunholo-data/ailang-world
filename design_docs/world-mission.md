...
4d. [**RATIFIED by Mark 2026-08-03 (attended, see STATUS): FIX NOW — user_version LOUD pin + de-fang the sha256 self-bypass; frozen-store touch ratified → ROUTABLE.** [~~PARKED `needs-human-review`~~ 2026-07-30 (iter-41) — DESIGN DOC + FIVE FIRST-PARTY
...
4f. [**OD-6 RATIFIED by Mark 2026-08-03 (attended, see STATUS): BRANCH A — interleaved --record-pair, pair ID, control-reuse rejection; re-sized ~0.6–0.9d → ROUTABLE.** [~~PARKED `needs-human-review`~~ 2026-08-03 (iter-42) — DESIGN DOC LANDED (PR #31 → squash
