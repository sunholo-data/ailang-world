...
4. [**[IN-SPRINT] — M3.A LANDED 2026-07-28 (iter-31), dev CI green, PR #20 → squash `2edf2ef`,
   judge sonnet PASS 84/100 zero-blocking. M3.B is NEXT and is NOT blocked. M3.D is PARKED
   `needs-human-review` — ONE comment from Mark unparks it.**
   **M3.A shipped the law + core**: `design_docs/sketches/effectbroker.ail` (213 lines, Appendix A
   ...
   > **M3.D — PARKED `needs-human-review` 2026-07-28 (iter-31). THE RATIFIED FOLD-IN IS NOT
