...
- **THE RIG'S SHELL IS `zsh`, AND TWO OF THE SKILL'S OWN INSTRUMENT IDIOMS SILENTLY PRODUCE
  ...
  **The general rule all three instances teach: a remedy is an instrument too, and inherits the same
...
4d. [**[PARKED `needs-human-review` 2026-07-30 (iter-41) — DESIGN DOC + FIVE FIRST-PARTY
...
4e. [**[MECHANISM IDENTIFIED 2026-07-30 (iter-40) — DOC + REPRODUCTION FIXTURE LANDED, quorum 2 rounds
   + narrow-refinement carve-out revision applied; REMEDIATION PARKED `needs-human-review` on OD-1]**
...
4f. [**[QUEUED 2026-07-29 (iter-39)]** — raised by the controller's own Gate-4 bench re-measure,
   with the A/B evidence attached and already committed to `bench/BASELINE.md` in `460ade3`. Sized
   small (~0.25–0.5d). Pick alongside 4d/4e.]
