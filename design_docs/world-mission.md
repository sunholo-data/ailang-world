...
2. [PARKED — needs-human-review 2026-07-24 (iter 6): design DONE, SPRINT gated on Mark]
   **w-world-library-m1** · clause-1 · the semantic world library: World/Proposal/Transition/
   ...
   Conflict-Surface overlap → clarified in-doc, §14-forced). Bounded 1-revision-1-requorum budget
   exhausted → SPRINT (planner→executor) PARKED for Mark's one-time OK of the **narrow-refinement
   carve-out first-use** in World + the replay-orchestration framing (see the doc's Quorum Log).
