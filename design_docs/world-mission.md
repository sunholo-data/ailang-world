...
4. [**[IN-SPRINT] — M3.A LANDED 2026-07-28 (iter-31), PR #20 → squash `2edf2ef`, judge PASS
   ...
   **M3.C LANDED 2026-07-29 (iter-34), dev CI green both jobs, PR #23 → squash `cae04d2`, judge
   sonnet PASS 88/100 zero-blocking**.
   **M3.D IS RATIFIED — Mark, attended, `c26b27d`: OPTION (i), and Decision 3 REOPENED for a
   third `failed` arm. NO human gate is outstanding on this item.** M3.D is NEXT and is the
   item's LAST milestone — it owns AC14, AC16, AC19, the missing `### M3.D` doc section, and the
   move to `implemented/`. The design doc deliberately STAYS in `planned/` until then.**
...
4c. [QUEUED 2026-07-28 by Mark's M3.D ratification — picks AFTER item 4 completes]
