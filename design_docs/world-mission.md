...
| D-WORLD-32 | OPEN | **Rotate/revoke and replace the exposed local credential now, or defer?** A (recommended): rotate and replace, retiring the exposed value. B: defer, leaving it valid. Default while unattended: no account changes by this mission; rotation stays parked until owner confirmation at the next attended review. | Iter160 tool-transcript exposure; no value copied to GitHub. Controlplane inbox_1788674084211_78d26150; approvals inbox_1788674300667_58de2db6. |
<!-- decision-ledger:end -->
