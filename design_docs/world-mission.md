...
41. **[IN-SPRINT — RESUME POINT, NOT LANDED]** **w-setup-go-pin-unguarded** · **BUILT, EVALUATED
...
42. **w-canary-control-does-not-survive-a-floor-raise** · clause-2 · **A KNOWN-POSITIVE CONTROL
...
43. **w-floor-raise-coupling-inventory** · clause-2 · **THE `P6.V` SPRINT PROVED THAT RAISING THE
...
44. **w-miscompile-instrument-inert-in-ci** · clause-2 · **THE MISSION'S OWN FIRST-PARTY
...
45. **w-toolchain-pin-normalizer-accepts-malformed-gotoolchain** · clause-2 · **THE JUDGE'S
    ...
    silently imports the laxer one's tolerance into the stricter one.* · ~0.15d · gated on
    row 41 landing · queued iter-128 (evaluator-surfaced, controller-reproduced).
