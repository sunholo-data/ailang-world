...
7. [PARKED until 4 AND 6b land] **w-approval-inbox** · clause-5 · the approval inbox + provenance
   ...
   HUMAN-SURFACE.md** · ~2d
8. [**[IN-SPRINT] — THIS ITEM IS NOT BLOCKED ON MARK AND HAS NOT BEEN SINCE 2026-08-05. `SM.D`'S ENTRYPOINT DOES NOT EXIST, AND BUILDING IT IS HEADLESS-ROUTABLE WORK — THE NEXT UNIT OF WORK, GATED ON NOTHING** (attended session 2026-08-10).
...
9. [**[`9/OD-10` RATIFIED 2026-08-10 (Mark, attended) — ACCEPT. THE REMAINING HALF IS NO LONGER HUMAN-GATED; IT IS HEADLESS-ROUTABLE AND IS THE NEXT UNIT OF WORK FOR THIS ITEM.**
