...
non-nil; guard proven by a **compiling** mutant (`f9e2e40`). Twice a mutation redded for the wrong
reason — one never landed, one failed to build: *"vacuous"*, *"never ran"* and *"doesn't build"* are
three facts wearing one exit code.
